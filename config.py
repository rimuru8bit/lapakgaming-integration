...
LAPAK_PATH_GET_CATEGORIES = os.environ.get("LAPAK_PATH_GET_CATEGORIES", "/api/category")
LAPAK_PATH_GET_PRODUCTS = os.environ.get("LAPAK_PATH_GET_PRODUCTS", "/api/product")
LAPAK_PATH_GET_ALL_PRODUCTS = os.environ.get("LAPAK_PATH_GET_ALL_PRODUCTS", "/api/all-products")
